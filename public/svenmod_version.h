...
#define SVENMOD_API_MAJOR_VERSION			( 1 )
#define SVENMOD_API_MINOR_VERSION			( 0 )

#define SVENMOD_API_MAJOR_VERSION_STRING	"1"
...
#define SVENMOD_MINOR_VERSION				"0" // minor
#define SVENMOD_PATCH_VERSION				"0" // patch
