...
DECLARE_DEDUCE_FIELDTYPE(FIELD_TYPE_QANGLE, struct QAngle); // ToDo: implement QAngle class
DECLARE_DEDUCE_FIELDTYPE(FIELD_TYPE_QANGLE, const struct QAngle &);
DECLARE_DEDUCE_FIELDTYPE(FIELD_TYPE_QUATERNION, vec4_t); // ToDo: implement Quaternion class
DECLARE_DEDUCE_FIELDTYPE(FIELD_TYPE_QUATERNION, const vec4_t &);
